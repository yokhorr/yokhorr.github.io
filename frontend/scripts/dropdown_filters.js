...
cityMenu.addEventListener("click", (event) => {
    ...
    if (event.target.tagName === "LI") {
        ...
        cityDropdown.querySelector(".selected").textContent =
...
theatreMenu.addEventListener("click", (event) => {
    ...
    if (event.target.tagName === "LI") {
        ...
        if (index !== -1) {
            ...
            // Иначе, добавляем элемент в массив и добавляем класс 'active'
...
ageMenu.addEventListener("click", (event) => {
    ...
    if (event.target.tagName === "LI") {
        ...
        // Обновляем текст выбранного города
        ageDropdown.querySelector(".selected").textContent =
